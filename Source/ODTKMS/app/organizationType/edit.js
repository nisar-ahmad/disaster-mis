...
(function()
{
    ...
    var controllerId = 'organizationType';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            organizationType]);

    function organizationType($scope, $location, $window, $routeParams, common, config, datacontext, model)
    {
        var entity = 'Organization Type';
        ...
        function getEntity(forceRemote)
        {
            ...
            {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.organizationType.create();
                return vm.entity;
            }

            return datacontext.organizationType.getById(val, forceRemote)
        ...
        function goToIndex()
        {
            $location.path('/organizationTypes');
        }
