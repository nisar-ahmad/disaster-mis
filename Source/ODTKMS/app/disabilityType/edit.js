...
(function()
{
    ...
    var controllerId = 'disabilityType';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            disabilityType]);

    function disabilityType($scope, $location, $window, $routeParams, common, config, datacontext, model)
    {
        var entity = 'Disability Type';
        ...
        function getEntity(forceRemote)
        {
            ...
            {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.disabilityType.create();
                return vm.entity;
            }

            return datacontext.disabilityType.getById(val, forceRemote)
