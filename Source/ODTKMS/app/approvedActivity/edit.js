...
(function()
{
    ...
    var controllerId = 'approvedActivity';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            approvedActivity]);

    function approvedActivity($scope, $location, $window, $routeParams, common, config, datacontext, model)
    {
        var entity = 'Approved Head';
        ...
        function getEntity(forceRemote)
        {
            ...
            {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.approvedActivity.create();
                return vm.entity;
            }

            return datacontext.approvedActivity.getById(val, forceRemote)
        ...
        function goToIndex()
        {
            $location.path('/approvedActivities');
        }
