...
(function()
{
    ...
    var controllerId = 'academicQualification';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            academicQualification]);

    function academicQualification($scope, $location, $window, $routeParams, common, config, datacontext, model)
    {
        var entity = 'Academic Qualification';
        ...
        function getEntity(forceRemote)
        {
            ...
            {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.academicQualification.create();
                return vm.entity;
            }

            return datacontext.academicQualification.getById(val, forceRemote)
        ...
        function goToIndex()
        {
            $location.path('/academicQualifications');
        }
