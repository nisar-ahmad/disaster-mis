(function()
{
    ...
    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositoryParticipant]);

    function RepositoryParticipant(model, AbstractRepository)
    {
        var defaultSelect = 'participantId, name';
