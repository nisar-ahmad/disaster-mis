(function()
{
    ...
    var serviceId = 'repository.survey';

    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositorySurvey]);

    function RepositorySurvey(model, AbstractRepository)
    {
        var defaultSelect = 'surveyId, name';
        var defaultOrder = 'name';

        var resource = 'Surveys';
