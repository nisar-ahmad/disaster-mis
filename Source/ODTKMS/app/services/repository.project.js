(function()
{
    ...
    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositoryProject]);

    function RepositoryProject(model, AbstractRepository)
    {
        var defaultSelect = 'projectId, name';
