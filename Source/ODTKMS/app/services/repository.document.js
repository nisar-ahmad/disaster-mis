(function()
{
    ...
    var serviceId = 'repository.document';

    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositoryDocument]);

    function RepositoryDocument(model, AbstractRepository)
    {
        var defaultSelect = 'documentId, name';
