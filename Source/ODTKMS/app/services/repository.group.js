(function()
{
    ...
    var serviceId = 'repository.group';

    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositoryGroup]);

    function RepositoryGroup(model, AbstractRepository)
    {
        var defaultSelect = 'groupId, name';
        var defaultOrder = 'name';

        var resource = 'Groups';
        var entityName = model.entityNames.group;
