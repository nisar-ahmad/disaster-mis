(function()
{
    ...
    var serviceId = 'repository.trainingsession';

    angular.module('app').factory(serviceId, ['model', 'repository.abstract', RepositoryTrainingSession]);

    function RepositoryTrainingSession(model, AbstractRepository)
    {
        var defaultSelect = 'name';
        var defaultOrder = 'name';

        var resource = 'TrainingSessions';
