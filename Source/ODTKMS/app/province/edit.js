...
(function () {
    ...
    var controllerId = 'province';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            province]);

    function province($scope, $location, $window, $routeParams, common, config, datacontext, model) {
        var entity = 'Province';
        ...
        function getEntity(forceRemote) {
            ...
            if (val === 'new') {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.province.create();
                return vm.entity;
            }

            return datacontext.province.getById(val, forceRemote)
