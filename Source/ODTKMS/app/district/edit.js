...
(function()
{
    ...
    var controllerId = 'district';

    angular.module('app').controller(controllerId,
        ['$scope', '$location', '$window', '$routeParams', 'common', 'config', 'datacontext', 'model',
            district]);

    function district($scope, $location, $window, $routeParams, common, config, datacontext, model)
    {
        var entity = 'District';
        ...
        function init(results)
        {
            ...
            if(!vm.entity.province)
                vm.entity.province = vm.provinces[0];
        }
        ...
        function getEntity(forceRemote)
        {
            ...
            {
                vm.title = 'Add ' + entity;
                vm.entity = datacontext.district.create();
                return vm.entity;
            }

            return datacontext.district.getById(val, forceRemote)
